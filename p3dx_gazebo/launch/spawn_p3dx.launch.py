...
def generate_launch_description():
        ...
        parameters=[
            {
                ...
                "robot_description": Command(
                    [
                        "xacro ",
                        join(p3dx_description_path, "urdf/p3dx/pioneer3dx.xacro"),
                        " camera_enabled:=",
                        camera_enabled,
                        " lidar_enabled:=",
                        lidar_enabled,
    ...
    gz_ros2_bridge_namespace = Node(
        ...
        remappings=[
            ...
            (
                PathJoinSubstitution(
                    ["/", robot_namespace, robot_namespace, "RosAria/odom"]
                ),
                "RosAria/odom",
            ),
            (
                PathJoinSubstitution(["/", robot_namespace, robot_namespace, "scan"]),
                "scan",
            ),
            (
            ...
            (
                PathJoinSubstitution(
                    ["/", robot_namespace, robot_namespace, "camera/camera_info"]
                ),
                "camera/camera_info",
            ),
            (
    ...
    gz_ros2_bridge = Node(
        ...
        remappings=[
            ...
            (
                PathJoinSubstitution(
                    ["/world", world_name, "model/pioneer/joint_state"]
                ),
                "joint_states",
            ),
        ],
